      ...
      <div className="flex h-full w-full flex-col-reverse items-center justify-center gap-4 md:flex-row">
        <div className="flex h-full w-full flex-col items-center justify-center gap-[2.5rem] p-6">
          ...
          <p className="max-w-[450px] text-center font-light leading-[160%] text-[#C1B6A6]">
            Experience the vibrant flavors of Cafe Italia with every bite, from
            sizzling kebabs to freshly prepared mezes. Let the warm ambiance and
            Turkish hospitality transport you to the heart of Turkey. Whether
            it’s a casual lunch or a special celebration, every meal promises to
            be a memorable one.
          </p>
