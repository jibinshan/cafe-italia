  ...
  return (
    <section className="relative flex h-full w-full items-center justify-center p-4 lg:py-16">
      <div className="flex h-full w-full flex-col items-center justify-center gap-11 bg-[#050505]">
        <h2 className="text-center font-oswald text-8xl text-[#262626] md:left-[15%] md:text-8xl">
          The Cafe Italia
          <br />
          Story
        </h2>
        <div className="flex h-full w-full flex-col items-center justify-center gap-4 bg-[#050505] md:flex-row lg:px-24 lg:py-20">
          ...
          <div className="flex h-full w-full flex-col items-center gap-[2.5rem] p-6 md:w-1/2 md:items-start lg:ml-24">
            ...
            <p className="max-w-[450px] text-center font-light leading-[160%] text-[#C1B6A6] md:text-start">
              Located in the lively area of Majester, our restaurant is a
              gateway to the rich culinary traditions of Cafe Italia. Inspired
              by Turkey’s vibrant flavors and timeless recipes, we bring an
              authentic dining experience that celebrates the heart of Turkish
              cuisine. From the bustling spice markets of Cafe Italia to the
              warmth of family kitchens, every dish reflects the passion and
              ...
              eat—it’s a celebration of Cafe Italia charm, right here in
              Majester.
            </p>
          </div>
        </div>
