  ...
  return (
    <section className="relative flex h-full max-w-[1400px] flex-col items-center justify-center gap-7 bg-[#000000] px-7 py-10 lg:px-24 lg:py-20">
      <div className="z-10 flex h-full w-full flex-col items-center justify-center gap-5">
        <h3 className="experience-title -ml-[50px] font-inter text-sm font-[600] uppercase tracking-[1.76px] text-[#FBEAD2]">
          we offer
        </h3>
        <h1 className="head-experience animate-slide-in text-center font-montserrat text-4xl font-[700] italic sm:text-7xl md:text-center lg:leading-[80px]">
          Unforgettable <br /> Dining{" "}
      ...
      <div className="hidden w-0 lg:flex lg:w-full lg:flex-col lg:gap-7">
        <div className="experience-container relative -ml-[50px] w-full rounded-3xl">
          ...
          <Image
            ...
            height={1066}
            alt="side-close-up"
            className="h-[450px] w-[1300px] rounded-3xl object-cover md:rounded-none"
          />

          <div className="absolute bottom-7 left-3 z-20 flex flex-col gap-3 lg:bottom-28 lg:left-24 lg:gap-12">
            <h1 className="font-montserrat text-2xl font-[700] italic tracking-[-1.8px] text-[#FFF4E3] lg:text-6xl">
              Food
            </h1>
            <p className="max-w-[350px] font-roboto text-xs font-[400] tracking-[0.54px] text-[#FBEAD2] lg:max-w-[500px] lg:text-lg">
