    ...
    <section className="relative flex h-full flex-col items-start justify-center gap-7 bg-[#000000] py-10 pl-5 lg:flex-row lg:py-20 lg:pl-48">
      <div className="w-full lg:w-1/2">
        <div className="z-10 flex h-full w-full flex-col gap-5">
          ...
          <Link
            href="/"
            className="mr-5 flex max-w-full items-center justify-center gap-2 rounded-full bg-[#0a0a0a] py-5 font-oswald font-bold leading-[160%] text-white md:py-7 md:text-start lg:mr-0 lg:max-w-[330px]"
          >
      ...
      <div className="grid w-full grid-cols-2 overflow-hidden rounded-xl md:h-[565px] lg:w-1/2">
        <div
        ...
        >
          <Image
            ...
            height={564}
            alt="side-close-up"
            className="h-full w-full object-cover md:h-[282.5px]"
          />
          <div className={cn("hidden", mouse === "1" && "overlay flex")}></div>
        </div>
        <div
          className="relative h-fit w-fit overflow-hidden"
        ...
        >
          <Image
            ...
            className="h-full w-full object-cover md:h-[282.5px]"
          />
          <div className={cn("hidden", mouse === "2" && "overlay flex")}></div>
        </div>
        <div
          className="relative h-fit w-fit overflow-hidden"
        ...
        >
          ...
          />
          <div className={cn("hidden", mouse === "3" && "overlay flex")}></div>
        </div>
        <div
          className="relative h-fit w-fit overflow-hidden"
        ...
        >
          <Image
            ...
            className="h-full w-full object-cover"
          />
          <div className={cn("hidden", mouse === "4" && "overlay flex")}></div>
        </div>
      </div>
    </section>
  );
