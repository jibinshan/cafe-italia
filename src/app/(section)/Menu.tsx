  ...
  return (
    <section className="relative flex h-full w-full items-center justify-center overflow-hidden py-12 pl-0 lg:pr-8">
      ...
      <div className="absolute left-5 z-10 flex h-full w-full flex-col items-start justify-center gap-5 lg:left-44 lg:pr-16">
        <h3 className="title -ml-[50px] font-oswald uppercase">Explore menu</h3>
        <h1 className="head max-w-[500px] font-oswald text-6xl font-bold sm:text-7xl md:text-start">
          Cafe Italia
          <br />
          <span className="text-primary">Menu</span>
        </h1>
        <p className="menu-description mt-[50px] max-w-[300px] font-light leading-[160%] text-white md:text-start lg:max-w-[500px]">
          Our menu is crafted from a deep passion for Turkish flavors, with a
          focus on authenticity and quality. Every dish celebrates the rich
          culinary heritage of Turkey, prepared by skilled chefs who carefully
          select fresh, local ingredients. We invite you to experience the
          vibrant tastes of Cafe Italia, where each meal is a true labor of
          love.
        </p>
        <Link href="/menu">
          <Button className="menu-button mt-[50] flex items-center justify-center gap-3 rounded-none bg-primary px-6 py-7 font-oswald font-bold text-[#282828]">
            View Menu{" "}
      ...
      <div className="flex w-full gap-2 lg:gap-4">
        ...
        <div
          className="h-[598px] w-1/3 rounded-3xl"
          style={{
            backgroundImage: "url(/images/home/image3.jpg)",
            backgroundPosition: "center",
            backgroundSize: "cover", // Ensures the image covers the container while maintaining aspect ratio
            backgroundRepeat: "no-repeat",
          }}
